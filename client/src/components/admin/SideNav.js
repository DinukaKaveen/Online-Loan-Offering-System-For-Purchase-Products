...
export default function SideNav() {
  ...
  const Openbar = () => {
    sideBar.current.classList.toggle("left-[-300px]");
  };
    ...
    <div>
      ...
      <div className="bg-blue-600  font-[Poppins]">
        ...
        <div
          ...
          p-2 w-[250px] overflow-y-auto text-center bg-gray-900 shadow h-screen"
          ref={sideBar}
        >
            ...
            <div>
              ...
              <div className="p-2.5 mt-2 flex items-center rounded-md px-4 duration-300 cursor-pointer  hover:bg-blue-600">
                ...
                >
                  ...
                  <span className="text-sm rotate-0" id="arrow" ref={Arrow}>
                    <i className="bi bi-chevron-down"></i>
                  </span>
                </div>
              </div>
              <div
                className="leading-7 text-left text-sm font-thin mt-2 w-4/5 mx-auto hidden"
                id="submenu"
                ref={subMenu}
              >
